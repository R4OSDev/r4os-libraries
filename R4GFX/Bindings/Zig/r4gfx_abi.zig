...
pub const DeviceV1Client = struct {
    ...
    pub fn init(raw: *const r4os.abi.R4XStartContext) !DeviceV1Client {
        ...
        if (r4os.runtime_r4l.slotAddress(header, 192) == null) return error.MissingSlot;
        if (r4os.runtime_r4l.slotAddress(header, 200) == null) return error.MissingSlot;
        if (r4os.runtime_r4l.slotAddress(header, 208) == null) return error.MissingSlot;
        if (r4os.runtime_r4l.slotAddress(header, 216) == null) return error.MissingSlot;
        if (r4os.runtime_r4l.slotAddress(header, 224) == null) return error.MissingSlot;
        if (r4os.runtime_r4l.slotAddress(header, 232) == null) return error.MissingSlot;
    ...
    pub fn presentation_info(self: *const DeviceV1Client, device: *const R4GfxDevice, head_id: u32, output: *R4GfxPresentationInfo) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1PresentationInfoFn, self.header, 192) orelse unreachable;
        return function(device, head_id, output);
    }

    pub fn swapchain_open(self: *const DeviceV1Client, device: *const R4GfxDevice, request: *const R4GfxSwapchainDesc, output: *R4GfxSwapchain) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainOpenFn, self.header, 200) orelse unreachable;
        return function(device, request, output);
    }

    pub fn swapchain_acquire(self: *const DeviceV1Client, device: *const R4GfxDevice, chain: *const R4GfxSwapchain, input_ns: u64, output: *R4GfxSwapchainFrame) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainAcquireFn, self.header, 208) orelse unreachable;
        return function(device, chain, input_ns, output);
    }

    pub fn swapchain_present(self: *const DeviceV1Client, device: *const R4GfxDevice, chain: *const R4GfxSwapchain, request: *const R4GfxSwapchainPresent) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainPresentFn, self.header, 216) orelse unreachable;
        return function(device, chain, request);
    }

    pub fn swapchain_poll(self: *const DeviceV1Client, device: *const R4GfxDevice, chain: *const R4GfxSwapchain, output: *R4GfxSwapchainStatus) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainPollFn, self.header, 224) orelse unreachable;
        return function(device, chain, output);
    }

    pub fn swapchain_release(self: *const DeviceV1Client, device: *const R4GfxDevice, chain: *const R4GfxSwapchain, frame: *const R4GfxSwapchainFrame) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainReleaseFn, self.header, 232) orelse unreachable;
        return function(device, chain, frame);
    }

    pub fn swapchain_resize(self: *const DeviceV1Client, device: *const R4GfxDevice, chain: *const R4GfxSwapchain, request: *const R4GfxSwapchainDesc) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainResizeFn, self.header, 240) orelse unreachable;
        return function(device, chain, request);
    }

    pub fn swapchain_close(self: *const DeviceV1Client, device: *const R4GfxDevice, chain: *const R4GfxSwapchain) i32 {
        const function = r4os.runtime_r4l.functionAt(DeviceV1SwapchainCloseFn, self.header, 248) orelse unreachable;
