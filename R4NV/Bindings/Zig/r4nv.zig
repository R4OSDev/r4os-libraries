...
pub const shader_resource_abi: u32 = 4;
...
pub const shader_cache_max_bytes: u32 = 16384;
...
pub const shader_profile_encode_fragment: u32 = 9;
...
pub const native_engine_encode: u32 = 16;
...
pub const BackendV1Client = struct {
    ...
    pub fn image_layout(self: *const BackendV1Client, profile: *const R4NvDeviceProfile, request: *const R4NvImageRequest, output: *R4NvImagePlan) i32 {
        const function = r4os.runtime_r4l.functionAt(BackendV1ImageLayoutFn, self.header, 56) orelse unreachable;
