/* R4OS freestanding profile, derived from FFmpeg 9.0.1 configure.
 * Canonical target capabilities; never use build-host OS probes here. */
#ifndef FFMPEG_CONFIG_H
#define FFMPEG_CONFIG_H
#define FFMPEG_CONFIGURATION "R4OS x86_64 H.264/HEVC/VP9/MPEG2/VC1/JPEG, LGPL, C17, pthread transport, runtime x86 SIMD; no host OS libraries"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR ""
#define AVCONV_DATADIR ""
#define CC_IDENT "clang 19.1.7, R4OS freestanding"
#define OS_NAME r4os
