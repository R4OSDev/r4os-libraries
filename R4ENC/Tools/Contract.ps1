...
$options = @("--$Mode", '--module-name', 'R4ENC', '--export', 'ENCODE_V1:r4enc_encode_v1:1')
$files = [ordered]@{
    contract = 'Contract/LibraryContract.json'; baseline = 'Contract/LibraryContract.baseline.json'
    'implementation-zig' = 'Contract/Generated/implementation_abi.zig'; 'binding-zig' = 'Bindings/Zig/r4enc.zig'
    'binding-c' = 'Bindings/C/r4enc.h'; 'fixture-zig' = 'Tests/Generated/contract_conformance.zig'
...
try {
    ...
    if ($LASTEXITCODE) { throw "R4ENC contract generation failed ($LASTEXITCODE)." }
