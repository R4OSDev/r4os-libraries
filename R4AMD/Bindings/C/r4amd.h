...
#define R4AMD_GC_9_2_2 ((uint32_t)590338)
#define R4AMD_SDMA_4_1_1 ((uint32_t)262401)
#define R4AMD_VCN_1_0_1 ((uint32_t)65537)
#define R4AMD_RAVEN2_VCN_FIRMWARE ((uint32_t)51441669)
#define R4AMD_SHADER_RAVEN2_BASE ((uint32_t)6)
